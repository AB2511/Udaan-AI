/**
 * Centralized Enum Definitions for UdaanAI Frontend
 * 
 * This file contains all enum constants used across the frontend application
 * to ensure consistency between frontend and backend validation.
 * 
 * IMPORTANT: All enum values MUST match exactly with backend/constants/enums.js
 * Any changes here should be synchronized with the backend definitions.
 */
...
// Helper functions for enum validation on frontend
export const EnumValidators = {
   ...
   * @returns {Array} - Filtered enum values
   */
  filterValues(enumArray, searchTerm) {
    if (!searchTerm) return enumArray;
    
    const term = searchTerm.toLowerCase();
    return enumArray.filter(value => 
      value.toLowerCase().includes(term) ||
      this.getDisplayName(value).toLowerCase().includes(term)
    );
  }
};
...
// Commonly used enum combinations for forms and validation
export const FORM_ENUMS = {
  // Assessment form enums
  ASSESSMENT_DOMAINS: ASSESSMENT_ENUMS.DOMAINS,
  ASSESSMENT_DIFFICULTIES: ASSESSMENT_ENUMS.DIFFICULTIES,
  ASSESSMENT_QUESTION_COUNTS: ASSESSMENT_ENUMS.QUESTION_COUNTS,
  
  // Interview form enums
  INTERVIEW_SESSION_TYPES: INTERVIEW_ENUMS.SESSION_TYPES,
  INTERVIEW_DIFFICULTIES: INTERVIEW_ENUMS.DIFFICULTIES,
  INTERVIEW_CATEGORIES: INTERVIEW_ENUMS.CATEGORIES,
  INTERVIEW_ROLES: INTERVIEW_ENUMS.ROLES,
  INTERVIEW_EXPERIENCE_LEVELS: INTERVIEW_ENUMS.EXPERIENCE_LEVELS,
  
  // Profile form enums
  PROFILE_GRADES: PROFILE_ENUMS.GRADES,
  PROFILE_EXPERIENCE_LEVELS: PROFILE_ENUMS.EXPERIENCE_LEVELS,
  PROFILE_CAREER_GOALS: PROFILE_ENUMS.CAREER_GOALS,
  PROFILE_SKILLS: PROFILE_ENUMS.SKILLS,
  PROFILE_INTERESTS: PROFILE_ENUMS.INTERESTS,
  PROFILE_INDUSTRIES: PROFILE_ENUMS.INDUSTRIES,
  
  // Resume form enums
  RESUME_FILE_TYPES: RESUME_ENUMS.FILE_TYPES,
  RESUME_ANALYSIS_TYPES: RESUME_ENUMS.ANALYSIS_TYPES
};
